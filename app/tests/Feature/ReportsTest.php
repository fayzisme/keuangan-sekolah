...
it('arrears report returns sisa > 0 per invoice', function () {
    seedReportData();
    $school = School::first();
    $action = new \App\Domain\Reports\Actions\GenerateArrearsReportAction();
...
it('arrears filter by class_id', function () {
    seedReportData();
    $school = School::first();
    $class = \App\Domain\School\Models\ClassRoom::first();
    $action = new \App\Domain\Reports\Actions\GenerateArrearsReportAction();
...
it('arrears filter by academic_year_id', function () {
    seedReportData();
    $school = School::first();
    $year = \App\Domain\School\Models\AcademicYear::first();
    $action = new \App\Domain\Reports\Actions\GenerateArrearsReportAction();
    ...
    $year2 = \App\Domain\School\Models\AcademicYear::create(['school_id' => $school->id, 'name' => '2024/2025', 'semester' => 'ganjil']);
...
it('student report calculates totals correctly', function () {
    [$school, $year, $class, $bt, $btGedung, $s1, $s2, $inv1, $inv2, $inv3, $invG, $p1, $p2] = seedReportData();
    $action = new \App\Domain\Reports\Actions\GenerateStudentReportAction();
...
it('class report sums correctly', function () {
    ...
    $school = School::first();
    $class = \App\Domain\School\Models\ClassRoom::first();
    $action = new \App\Domain\Reports\Actions\GenerateClassReportAction();
